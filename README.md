...
These define _behavioral contracts_ for data structure interactions.
...
1. **Every class with dynamic memory** must explicitly define all **five special member functions** (The Big 5):
   ...
   - Move Constructor
   - Move Assignment
2. **LinkedList-based classes** should **delegate these for internal list members**: - The contained `LinkedList<T>` handles its Big Five. - Derived objects correctly follow composition semantics.
